<!DOCTYPE html>
 <html dir="ltr">
   <head>
<!-- Original URL: https://demos.wrappixel.com/premium-admin-templates/bootstrap/adminpro-bootstrap/package/html/main/authentication-login1.html
Date Downloaded: 2021-12-04 12:37:56 PM !-->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
   ...
   <body>
     <div class="main-wrapper">
      ...
      @endif
                 <form method="post" class="form-horizontal mt-3 form-material" id="loginform" action="/employe/checklogin">
                  @csrf
                   ...
                   <div class="form-group">
                     <div class="d-flex">
                       <div class="checkbox checkbox-info pt-0">
                         <input id="checkbox-signup" type="checkbox" class="material-inputs chk-col-indigo" value="1" />
                         <label for="checkbox-signup"> Remember me  </label>
                       </div>
                       <div class="ms-auto">
                         <a href="javascript:void(0)" id="to-recover" class="
                            link
                            font-weight-medium
                            d-flex
                            align-items-center
                          "><i class="ri-lock-line fs-5 me-1"></i> Forgot pwd? </a>
                       </div>
                     </div>
                   </div>
           ...
           <div id="recoverform">
             <div class="logo">
               ...
               <span class="text-muted">Enter your Email and ____________ will be sent to ___! </span>
             </div>

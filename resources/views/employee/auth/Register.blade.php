<!DOCTYPE html>
 <html dir="ltr">
   <head>
<!-- Original URL: https://demos.wrappixel.com/premium-admin-templates/bootstrap/adminpro-bootstrap/package/html/main/authentication-register1.html
         ...
         <div class="auth-box p-4 bg-white rounded">
           <div>
             <div class="logo text-center">
               ...
               <h5 class="font-weight-medium mb-3 mt-1"><b>Sign Up</b></h5>
             </div>
             <!-- Form -->
             <div class="row mt-4">
               <div class="col-12">
                 <form class="form-horizontal" action="index.html">
                   ...
                   <div class="checkbox checkbox-primary mb-3">
                     ...
                     <label for="checkbox-signup">
                      I agree __ all  <a href="#">Terms </a></label>
                   </div>

<!DOCTYPE html>
 <html dir="ltr" lang="en">
   <head>
<!-- Original URL: https://demos.wrappixel.com/premium-admin-templates/bootstrap/adminpro-bootstrap/package/html/main/index3.html
Date Downloaded: 2021-12-04 12:37:24 PM !-->
             ...
             <ul class="navbar-nav justify-content-end">
                         ...
                         <div class="accordion-item">
                           ...
                           <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                             <div class="accordion-body">
                              Anim pariatur cliche reprehenderit, ____ eiusmod
                              high life accusamus terry __________ ad squid.
                             </div>
                           </div>
                         </div>
                         <div class="accordion-item">
               ...
               <li class="nav-item dropdown">
                 <a class="
                    ...
                    text-muted
                    waves-effect waves-dark
                  " href="index3.html" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         ...
         <div class="container-fluid">
                 ...
                 <div class="card-body">
                   <div class="d-flex no-block">
                     ...
                     <div class="align-self-center">
                       <h6 class="text-white mt-2 mb-0">Total Income </h6>
                 ...
                 <div class="card-body">
                   <div class="d-flex no-block">
                     ...
                     <div class="align-self-center">
                       ...
                       <h2 class="mt-0 text-white">987,563 </h2>
                     </div>
                   </div>
                 </div>
               </div>
           ...
           <div class="row">
                   ...
                   <div class="d-md-flex">
                     ...
                     <div class="ms-auto">
                       <select class="form-select">
                         <option selected="" />January 2021 
                         <option value="1" />February 2021 
                         <option value="2" />March 2021 
                         <option value="3" />April 2021 
                       </select>
                     </div>
                   </div>
                 </div>
             ...
             <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
               <div class="card w-100">
                 <img class="card-img-top blog-img3" src="../../assets/images/big/img1.jpg" alt="Card image cap" />
                 <div class="card-body">
                   ...
                   <p class="mb-0 mt-3">
                    Titudin venenatis ipsum aciat. _______ ullamer quam. nenatis
                    ipsum ac _______. Ibulum ullamcorper.aciat. Vestibu ullamer
                    quam. _______
                   </p>
                   <div class="d-flex mt-2">
                     <button class="btn ps-0 btn-link">Read more </button>
                     <div class="ms-auto align-self-center">
                       <a href="javascript:void(0)" class="link me-2"><i class="ri-heart-fill"></i></a>
                       <a href="javascript:void(0)" class="link me-2"><i class="ri-share-fill"></i></a>
                     </div>
                   </div>
                 </div>
               </div>
             ...
             <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
               <div class="card w-100">
                 <div class="card-body">
                   <h4 class="card-title">
                     <span class="lstick d-inline-block align-middle"></span>Visit Separation
                   </h4>
                   <div id="Visit-Separation" style="height: 270px; width: 100%" class="d-flex justify-content-center align-items-center"></div>
             ...
             <div class="col-lg-8">
               <div class="card">
                 <div class="card-body">
                   ...
                   <div id="Website-Visit" class="position-relative mt-3" style="height: 350px; width: 100%"></div>
                 </div>
               </div>
             </div>
           </div>
                   ...
                   <div class="table-responsive mt-3">
                     <table class="table v-middle no-wrap mb-0">
                       ...
                       <tbody>
                         <tr>
                           <td style="width: 50px">
                             <span><img src="../../assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle" /></span>
                           </td>
                           <td>
                         ...
                         <tr class="active">
                           <td>
                             <span><img src="../../assets/images/users/2.jpg" alt="user" width="50" class="rounded-circle" /></span>
                           </td>
                           <td>
                         ...
                         <tr>
                           <td>
                             <span><img src="../../assets/images/users/3.jpg" alt="user" width="50" class="rounded-circle" /></span>
                           </td>
                           <td>
                         ...
                         <tr>
                           <td>
                             <span><img src="../../assets/images/users/4.jpg" alt="user" width="50" class="rounded-circle" /></span>
                           </td>
                           <td>
                         ...
                         <tr>
                           <td>
                             <span><img src="../../assets/images/users/5.jpg" alt="user" width="50" class="rounded-circle" /></span>
                           </td>
                           <td>
                         ...
                         <tr>
                           <td>
                             <span><img src="../../assets/images/users/6.jpg" alt="user" width="50" class="rounded-circle" /></span>
                           </td>
                           <td>
                   ...
                   <div class="card-body pt-0">
                     ...
                     <div class="activity-item mb-4 d-flex">
                       ...
                       <div class="mt-2">
                         ...
                         <h6 class="text-muted">
                          joined projectname, and _______
                         ...
                         <span class="image-list mt-2">
                           <a href="javascript:void(0)" class="align-middle position-relative">
                             <img src="../../assets/images/users/1.jpg" class="rounded-circle" alt="user" width="40" />
                           </a>
                           <a href="javascript:void(0)" class="align-middle position-relative">
                             <img src="../../assets/images/users/4.jpg" class="rounded-circle" alt="user" width="40" />
                           </a>
                           <a href="javascript:void(0)" class="align-middle position-relative">
                             <span class="
                                round
                                ...
                                text-center
                                bg-warning
                              " style="height: 40px; width: 40px">C </span>
                           </a>
                           <a href="javascript:void(0)" class="align-middle position-relative">
                             <span class="
                                round
                                ...
                                text-center
                                bg-danger
                              " style="height: 40px; width: 40px">S </span>
                           </a>
                     ...
                     <div class="activity-item mb-4 d-flex">
                       ...
                       <div class="mt-2">
                         ...
                         <h6 class="text-muted">uploaded this file </h6>
                         <span>
                           <a href="javascript:void(0)" class="me-2"><img src="../../assets/images/big/img1.jpg" alt="user" width="60" /></a>
                           <a href="javascript:void(0)" class="me-2"><img src="../../assets/images/big/img2.jpg" alt="user" width="60" /></a>
                         </span>
                       </div>
                     </div>
                     <!-- Activity item-->
                     ...
                     <div class="activity-item d-flex mb-2">
                       ...
                       <div class="mt-2">
                         ...
                         <p class="mb-0">
                          It has survived ___ only five centuries, but ____ the
                          leap into
                         </p>
                       </div>
                     </div>
           ...
           <div class="row">
             <div class="col-lg-6">
               <div class="card">
                 <div class="card-body">
                   <h4 class="card-title">
                     <span class="lstick d-inline-block align-middle"></span>Recent Comments
                   </h4>
                 </div>
                   ...
                   <div class="d-flex flex-row comment-row border-bottom p-3">
                     ...
                     <div class="comment-text w-100 p-3">
                       ...
                       <p class="mb-1 fs-3 text-muted">
                        _____ Ipsum is simply dummy ____ of the printing and
                        type etting ________
                       </p>
             ...
             <div class="col-lg-6">
               <div class="card">
                 <div class="card-body">
                   <h4 class="card-title">
                     <span class="lstick d-inline-block align-middle"></span>Recent Chats
                   </h4>
                       ...
                       <li class="mt-4">
                         ...
                         <div class="chat-content ps-3 d-inline-block">
                           ...
                           <div class="
                              ...
                              text-dark
                            ">
                            Lorem _____ is simply dummy text __ the printing &
                       ...
                       <li class="mt-4">
                         ...
                         <div class="chat-content ps-3 d-inline-block">
                           ...
                           <div class="
                              ...
                              text-dark
                            ">
                            It’s _____ opportunity to work.
                           </div>
                         </div>
                         <div class="
                            chat-time
                       ...
                       <li class="odd mt-4">
                         <div class="chat-content ps-3 d-inline-block text-end">
                           <div class="
                              ...
                              text-dark
                            ">
                            Whats ______ of the new project.
                           </div>
                         </div>
                         <div class="
                            chat-time
                       ...
                       <li class="mt-4">
                         ...
                         <div class="chat-content ps-3 d-inline-block">
                           ...
                           <div class="
                              ...
                              text-dark
                            ">
                            Well __ have good budget for ___ project
                           </div>
                         </div>
                         <div class="
                            chat-time

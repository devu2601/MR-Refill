...
<div align="right "style="margin-right: 20px;"> 
    ...
    <h6 class="word-rotator font-weight-semi-bold slide mb-2">  
										<span class="word-rotator-words">
											<b class="is-visible"> <a  href="/User/login"><u>Already Registered? Login</u></a></b>
										</span>
									</h6>
</div>
            ...
            <div class="container py-4">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-5">
                        ...
                        @endif
                        <form action="/User/register/checkregister" enctype="multipart/form-data" id="frmSignUp" method="post">
                            @csrf
                            <div class="row">
                                <div class="form-group col">
                                    <label class="form-label text-color-dark text-3" >Name  <span class="text-color-danger">*</span></label>
                                    <input type="text" value="" class="form-control form-control-lg text-4" name="regname" required> </div>
                            </div>
                            <div class="row">
                                <div class="form-group col">
                                    <label class="form-label text-color-dark text-3" >Phone no. <span class="text-color-danger">*</span></label>
                                    <input type="text" value="" class="form-control form-control-lg text-4" name="regphno" required> </div>
                            </div>
                            <div class="row">
                                <div class="form-group col">
                                    <label class="form-label text-color-dark text-3" >Email address  <span class="text-color-danger">*</span></label>
                                    <input type="email" value="" class="form-control form-control-lg text-4" name="regemail" required> </div>
                            </div>
                            <div class="row">
                                <div class="form-group col">
                                    <label class="form-label text-color-dark text-3">Profile pic <span class="text-color-danger">*</span></label>
                                    <input type="file" value="" class="form-control form-control-lg text-4" name="regimage" required> </div>
                            </div>

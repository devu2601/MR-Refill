				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 align-self-center p-static order-2 text-center">
							<h1 class="text-dark font-weight-bold text-8">CATEGORY</h1> 
								...
								<div class="col-md-4">
									<article class="post post-medium border-0 pb-0 mb-5">
										<div class="post-image">
											<a href="/User/categorylist/search/{{ $row->cat_id }}"> <img src="{{ URL::to('/') }}/uploads/category/{{ $row->cat_img }}" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" /> </a>
										</div>
										<div class="post-content">
											<h2 class="font-weight-semibold text-5 line-height-6 mt-3 mb-2"><a href="/User/categorylist/search/{{ $row->cat_id }}">{{ $row->cat_name }}</a></h2>
										</div>
									</article>
								</div>
								<?php  } ?>

...
<div role="main" class="main shop pt-4">
			<div class="container">
				...
				<div class="row mb-4">
					...
					<div class="row">
						<div class="col">
							<form action="/User/exchange/review2/insert" id="submitReview" method="post">
								@csrf
                                <input type="hidden" name="requestid" id="requestid" value="{{$requestid1}}">
                                <input type="hidden" name="empid" id="empid" value="{{$emp_data->employee_id}}">

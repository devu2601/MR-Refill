				...
				<div class="row justify-content-center">
					<div class="col-lg-8">
						<ul class="breadcrumb breadcrumb-dividers-no-opacity font-weight-bold text-6 justify-content-center my-5">
							...
							<li class="text-transform-none text-color-dark"> <a href="/User/exchange/complete" class="text-decoration-none text-color-primary">Request Complete</a> </li>
						</ul>
					</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-lg-8">
						<div class="card border-width-3 border-radius-0 border-color-success">
							<div class="card-body text-center">
								<p class="text-color-dark font-weight-bold text-4-5 mb-0"><i class="fas fa-check text-color-success me-1"></i> Thank You. Your Request has been received.</p>
							</div>
						</div>
						...
						<div class="row justify-content-center">
							...
							<a href="/User/exchange/viewrequests" class="btn btn-3d btn-primary mb-2" >View Exchange Requests</a>

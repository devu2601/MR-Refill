            ...
            <div class="container py-4">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-5">
                        ...
                        <form action="/User/register/checkotpregister" enctype="multipart/form-data" id="frmSignUp" method="post">
                            @csrf
                            <div class="row">
                                <div class="form-group col">
                                    <label class="form-label text-color-dark text-3">OTP  <span class="text-color-danger">*</span></label>
                                    <input type="text" value="" class="form-control form-control-lg text-4" name="txtotp" required> </div>
                            </div>

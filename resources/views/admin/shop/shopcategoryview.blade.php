...
@section("admin-viewcategory-section")
<div class="container-fluid">
           <div class="row page-titles">
             <div class="col-md-5 col-12 align-self-center">
               <h3 class="text-themecolor mb-0">Manage Category </h3>
             </div>
           ...
           <div class="row">
             <div class="col-12">
               <div class="card">
                 ...
                 <form action="/admin/shop/category" method="get"> 
                    <div class="row">
                      <div class="col-10"> 
                        <h4 class="card-title mb-0">All Category </h4>
                      </div>
                      <div class="col-2">
                        <button class="btn btn-success" type="submit" name="addbtn">Add Category</button>
                      </div>
                     ...
                     <table id="zero_config" class="table table-striped table-bordered">
                       ...
                       <tbody align="center">
                         ...
                         <tr>
                           ...
                           <td>{{ $row->cat_name }} </td>
                           <td>
                             <a href="{{ URL::to('/') }}/uploads/category/{{ $row->cat_img }}" target="_blank"><img height="50" width="70" src="{{ URL::to('/') }}/uploads/category/{{ $row->cat_img }}"/></a>
                            </td>
                            <td>{{ $row->cat_status }}</td>
                           <td>
                              @if( $row->cat_status =="Active")
                                <a href="/admin/shop/category/changestatus/{{ $row->cat_id }}" class="btn btn-danger btn-xs btnshow" title="Block"><i data-feather="x-circle" class="feather feather-x feather-sm"></i></a>
                              @else
                                <a href="/admin/shop/category/changestatus/{{ $row->cat_id }}" class="btn btn-primary btn-xs btnbtn btnshow" title="Active"><i data-feather="user-check" class="feather feather-x feather-sm"></i></a>
                              @endif
                            <a href="/admin/shop/updatecategory/{{ $row->cat_id }}" ><button type="button" class="btn waves-effect waves-light btn-info">
                       ...
                       <div class="modal-dialog">
                         <div class="modal-content">
                           ...
                           <div class="modal-footer">
                             <form action="/admin/shop/category/delete" method="post">
                               @csrf
                             <input type="hidden" id="deleteid" name="deleteid"/>
                                  <input type="hidden" name="cat_name" id="cat_name">
                                  <input type="hidden" name="cat_img" id="cat_img">

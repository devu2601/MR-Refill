...
@section("admin-viewbrand-section")
                     ...
                     <table id="zero_config" class="table table-striped table-bordered">
                       ...
                       <tbody align="center">
                         ...
                         <tr>
                           ...
                           <td><img height="50" width="70" src="{{ URL::to('/') }}/uploads/brand/{{ $row->brand_logo }}" />  </td>
                           <td>{{ $row->brand_status }}</td>
                           <td>
                              @if( $row->brand_status == "Active")
                                <a href="/admin/shop/brand/changestatus/{{ $row->brand_id }}" class="btn btn-danger btn-xs btnshow" title="Block"><i data-feather="x-circle" class="feather feather-x feather-sm"></i></a>
                              @else
                                <a href="/admin/shop/brand/changestatus/{{ $row->brand_id }}" class="btn btn-primary btn-xs btnbtn btnshow" title="Active"><i data-feather="user-check" class="feather feather-x feather-sm"></i></a>
                              @endif
                              <a href="/admin/shop/updatebrand/{{ $row->brand_id }}"><button type="button" class="btn waves-effect waves-light btn-info">

...
@section("admin-view_pending_request-section")
<div class="container-fluid">
           <div class="row page-titles">
             <div class="col-md-5 col-12 align-self-center">
               <h3 class="text-themecolor mb-0">Pending Request Details </h3>
             </div>
           </div>
           <!-- -------------------------------------------------------------- -->
           <!-- Start Page Content -->
           ...
           <div class="row">
             <div class="col-12">
               <div class="card">
                 ...
                 <div class="card-body">
                  <form action="/admin/exchange/status_change_approved/{{ $pending_data[0]->request_id }}">
                    @csrf
                       ...
                       <div class="table-responsive">
                         <table class="table">
                           <tbody>
                             ...
                             <tr>
                               <th>Model name </th>
                               <td>{{ $pending_data[0]->model_name }} </td>
                             </tr>
                             <tr>
                            <!-- <th>Date of appointment</th>
                            <td>{{ $pending_data[0]->exchange_date }} </td>
                        </tr> -->
                        <tr>
                           <th>Date and time appointment</th>
                           <td>{{ $pending_data[0]->exchange_time }}  </td>
                        </tr>
                        <tr>
                           <th>Address </th>
                           <td>{{ $pending_data[0]->exchange_address }}</td>
                        </tr>
                        <tr>   
                           <th>Landmark </th>
                           <td>{{ $pending_data[0]->exchange_landmark }}</td>
                        </tr>
                        <tr>
                           <th>Pincode </th>
                           <td>{{ $pending_data[0]->exchange_pincode }}</td>
                        </tr>
                        <tr>
                           <th>Latitude</th>
                           <td>{{ $pending_data[0]->exchange_latitude }}  </td>
                        </tr>
                        <tr>
                           <th>Longitude</th>
                           <td>{{ $pending_data[0]->exchange_longititute }}  </td>
                        </tr>
                        <tr>
                           <th>Status</th>
                           <td>{{ $pending_data[0]->exchange_status }}  </td>
                        </tr>
                        <tr>
                           <th>Payment type</th>
                           <td>{{ $pending_data[0]->payment_type }}  </td>
                        </tr>
                        <tr>
                           <th>Total payment</th>
                           <td>{{ $pending_data[0]->payment_amount }}  </td>
                        </tr>
                        <tr>
                            <th>Action</th>
                            <td>
                              <button type="submit" class="btn waves-effect waves-light btn-light-success">Approve</button>
                              <a href="/admin/exchange/cancel/request/{{ $pending_data[0]->request_id }}"><button type="button" class="btn waves-effect waves-light btn-light-danger">Reject</button></a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="/admin/exchange/pending"><button type="button" class="btn waves-effect waves-light btn-info">Back</button></a></td>
                        </tr>
                           </tbody>
                         </table>
                       </div>

...
@section("admin-exchange-updatemodel")
<section class="content">
        <div class="card card-primary card-outline">
			<div class="card-header">
      		<h3 class="m-0"><b><b>Update Model</b> </b></h3>
    	    </div>
		<div class="card-body">
			...
			@endif
				<form action="/admin/exchange/savemodel" method="post" enctype="multipart/form-data" id="addEditcategory" novalidate="novalidate">
				@csrf						
						<div class="card-body">
						<input value="{{ $singlerow[0]->model_id }}" type="hidden" name="txtmodelid" />
						<input value="{{ $singlerow[0]->model_img_url }}" type="hidden" name="txtoldimage" />

                            <div class="form-group">
								<label><b>Name</b></label>
								<input value="{{ $singlerow[0]->model_name }}" type="text" class="form-control" id="txtmodelname" placeholder="Enter the model name" name="txtmodelname">
							</div>
							<br>
                            <div class="form-group">
								<label><b>Price</b></label>
								<input value="{{ $singlerow[0]->model_price }}" type="text" class="form-control" id="txtmodelprice" placeholder="Enter the model price" name="txtmodelprice">
							</div>
							<br>
                            <div class="form-group">
								<label><b>Model image<b></label>
								<input type="file" class="form-control" id="image" name="txtmodelimage">
								<img height="100" width="150" src="{{ URL::to('/') }}/uploads/models/{{ $singlerow[0]->model_img_url }}" />  
						...
						<div class="card-footer">
							...
							<a href="/admin/exchange/model/view" class="btn btn-primary">Back</a>

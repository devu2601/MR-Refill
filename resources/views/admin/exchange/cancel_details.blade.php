...
@section("admin-view_cancle_request-section")
<div class="container-fluid">
           <div class="row page-titles">
             <div class="col-md-5 col-12 align-self-center">
               <h3 class="text-themecolor mb-0">Cancled Request Details </h3>
             </div>
           </div>
           <!-- -------------------------------------------------------------- -->
           <!-- Start Page Content -->
           ...
           <div class="row">
             <div class="col-12">
               <div class="card">
                 ...
                 <div class="card-body">
                  <form action="/admin/exchange/status_change_approved/{{ $canceled_data[0]->request_id }}">
                    @csrf
                       ...
                       <div class="table-responsive">
                         <table class="table">
                           <tbody>
                             <tr>
                               <th>User name </th>
                               <td>{{ $canceled_data[0]->user_name }} </td>
                             </tr>
                             <tr>
                               <th>Model name </th>
                               <td>{{ $canceled_data[0]->model_name }} </td>
                             </tr>
                             <tr>
                            <th>Date of appointment</th>
                            <td>{{ $canceled_data[0]->exchange_date }} </td>
                        </tr>
                        <tr>
                           <th>Time of appointment</th>
                           <td>{{ $canceled_data[0]->exchange_time }}  </td>
                        </tr>
                        <tr>
                           <th>Address </th>
                           <td>{{ $canceled_data[0]->exchange_address }}</td>
                        </tr>
                        <tr>   
                           <th>Landmark </th>
                           <td>{{ $canceled_data[0]->exchange_landmark }}</td>
                        </tr>
                        <tr>
                           <th>Pincode </th>
                           <td>{{ $canceled_data[0]->exchange_pincode }}</td>
                        </tr>
                        <tr>
                           <th>Latitude</th>
                           <td>{{ $canceled_data[0]->exchange_latitude }}  </td>
                        </tr>
                        <tr>
                           <th>Longitude</th>
                           <td>{{ $canceled_data[0]->exchange_longititute }}  </td>
                        </tr>
                        <tr>
                           <th>Status</th>
                           <td>{{ $canceled_data[0]->exchange_status }}  </td>
                        </tr>
                        <tr>
                           <th>Payment type</th>
                           <td>{{ $canceled_data[0]->payment_type }}  </td>
                        </tr>
                        <tr>
                           <th>Total payment</th>
                           <td>{{ $canceled_data[0]->payment_amount }}  </td>
                        </tr>
                        <tr>
                           <th>Assign to </th>
                        ...
                        <tr>
                            <td colspan="2"><a href="/admin/exchange/cancel"><button type="button" class="btn waves-effect waves-light btn-primary">Back</button></a>
                          </td>
                        </tr>
                           </tbody>
                         </table>

...
@section("admin-exchange-model")
<section class="content">
            <div class="card card-primary card-outline">
			<div class="card">
                 <div class="border-bottom title-part-padding">
                   <h4 class="mb-0"><b><b>Add Model</b></b></h4>
                 </div>
		<div class="card-body">
			...
			<form id="form_category" action="/admin/exchange/model/insert" method="post" enctype="multipart/form-data" id="addEditcategory" novalidate="novalidate">
				@csrf
				<div class="card-body">
							<div class="form-group">
								<label for="txtmodelname">Name</label>
								<input type="text" class="form-control textbox" id="txtmodelname" placeholder="Enter the model name" name="txtmodelname" value="">
							</div>
							<br>
                            <div class="form-group">
								<label for="txtprice">Price</label>
								<input type="text" class="form-control textbox" id="txtprice" placeholder="Enter the model price" name="txtprice" value="">
							</div>
							<br>
							<div class="form-group">
								<label for="txtrprice"><b>Status</b></label><br>
								<input type="checkbox" checked data-toggle="toggle" data-onstyle="primary" value="Active" name="model_status" autocomplete="on">
							</div>
							<br>
							<div class="form-group">
								<label for="txtmodelimage">Image </label>
								<input type="file" class="form-control textbox" value="" id="txtmodelimage" name="txtmodelimage">
								<br>

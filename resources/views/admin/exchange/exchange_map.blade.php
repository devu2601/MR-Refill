...
@section("admin-exchange-map-section")
<div id="map" style="width: 100%; height: 600px;"></div>
<script src="http://maps.google.com/maps/api/js?key=AIzaSyAHC7ZZhrJsX0LhwNqKI5TKwhK-LHb_Lu0" 
          type="text/javascript"></script>
<script type="text/javascript">
    var locations = [
      @foreach($data as $row)
      [{{ $row->exchange_id; }}, {{ $row->exchange_latitude; }}, {{ $row->exchange_longititute; }}],
      @endforeach
    ];
    
    var map = new google.maps.Map(document.getElementById('map'), {
      zoom: 5,
      center: new google.maps.LatLng(22.919946, 71.759167),

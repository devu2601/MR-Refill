...
@endsection
@section("admin-exchange-complete")
             ...
             <div class="col-12">
               <div class="card">
                 ...
                 <form action="/admin/shop/brand" method="get"> 
                    <div class="row">
                      <div class="col-10"> 
                        <h4 class="card-title mb-0">Complete Request </h4>
                      </div>
                      <div class="col-2">
                     ...
                     <table id="zero_config" class="table table-striped table-bordered">
                       ...
                       <tbody align="center">
                         ...
                         <td>{{ $loop->index + 1 }} </td>
                           ...
                           <td>
                            <a href="/admin/exchange/complete/details/{{ $row->request_id }}" class="btn btn-success btn-xs btnshow" title="view"><i class="fa fa-eye"></i></a>
                           </td>
                         </tr>
                         @endforeach

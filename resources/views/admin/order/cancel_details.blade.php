...
@section("admin-view_cancle_orders-section")
<div class="container-fluid">
           <div class="row page-titles">
             <div class="col-md-5 col-12 align-self-center">
               <h3 class="text-themecolor mb-0">Cancel Details </h3>
             </div>
           </div>
           <!-- -------------------------------------------------------------- -->
           <!-- Start Page Content -->
                       ...
                       <div class="table-responsive">
                         <table class="table">
                           <tbody>
                              ...
                              <tr>
                                <th>Item Status</th>
                                <td>{{ $cancel_data[0]->item_status }}  </td>
                              </tr>
                              <tr>
                                <th>Item quantity</th>
                                <td>{{ $cancel_data[0]->item_quantity }}  </td>
                              </tr>
                              <tr>
                                <th>Total amount</th>
                                <td>{{ $cancel_data[0]->item_total }}  </td>
                              </tr>
                              <tr>
                                  <td colspan="2"><a href="/admin/order/cancel"><button type="button" class="btn waves-effect waves-light btn-info">Back</button></a></td>
                              </tr>
                           </tbody>
                         </table>
                       </div>

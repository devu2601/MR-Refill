             ...
             <div class="col-12">
               <div class="card">
                 ...
                 <form action="/shop/brand" method="get"> 
                    <div class="row">
                      <div class="col-10"> 
                        <h4 class="card-title mb-0">Process Orders </h4>
                      </div>
                      <div class="col-2">
                       ...
                       <tbody align="center">
                         ...
                         <tr>
                           ...
                           <td>
                            ...
                            <a href="/admin/order/invoice/{{ $row->order_id }}"><button type="button" class="btn waves-effect waves-light btn-success"><i class="fa fa-eye"></i></button></a><br>
                           </td>
                         </tr>
                         @endforeach

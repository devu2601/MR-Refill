...
@section("admin-viewstate-section")
<div class="container-fluid">
           <div class="row page-titles">
             <div class="col-md-5 col-12 align-self-center">
               <h3 class="text-themecolor mb-0">Manage State </h3>
             </div>
           ...
           <div class="row">
             <div class="col-12">
               <div class="card">
                 ...
                 <form action="/admin/utility/state" method="get"> 
                    <div class="row">
                      <div class="col-10"> 
                        <h4 class="card-title mb-0">All State </h4>
                      </div>
                      <div class="col-2">
                        <button class="btn btn-success" type="submit" name="addbtn">Add State</button>
                      </div>
                    </div>
                  </form>
                 </div>
                       ...
                       <tbody align="center">
                         ...
                         <tr>
                           ...
                           @if( $row->state_status =="Active")
                                <a href="/admin/utility/state/status_change/{{ $row->state_id }}" class="btn btn-danger btn-xs btnshow" title="Block"><i data-feather="x-circle" class="feather feather-x feather-sm"></i></a>
                              @else
                                <a href="/admin/utility/state/status_change/{{ $row->state_id }}" class="btn btn-primary btn-xs btnbtn btnshow" title="Active"><i data-feather="user-check" class="feather feather-x feather-sm"></i></a>
                              @endif
                     <a href="/admin/utility/updatestate/{{ $row->state_id }}"><button type="button" class="btn waves-effect waves-light btn-info">
                       ...
                       <div class="modal-dialog">
                         <div class="modal-content">
                           ...
                           <div class="modal-footer">
                             <form action="/admin/utility/state/delete" method="post">
                               @csrf

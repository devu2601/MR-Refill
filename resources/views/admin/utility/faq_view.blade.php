           ...
           <div class="row">
             <div class="col-12">
               <div class="card">
                 ...
                 <form action="/admin/utility/faq" method="get"> 
                    <div class="row">
                      <div class="col-10"> 
                        <h4 class="card-title mb-0">All FAQs </h4>
                      </div>
                      <div class="col-2">
                        <button class="btn btn-success" type="submit" name="addbtn">Add FAQ</button>
                      </div>
                     ...
                     <table id="zero_config" class="table table-striped table-bordered">
                       ...
                       <tbody align="center">
                         ...
                         <tr>
                           ...
                           <td>{{ $row->faq_status }} </td>
                           <td>
                              @if( $row->faq_status =="Active")
                                <a href="/admin/utility/faq/changestatus/{{ $row->faq_id }}" class="btn btn-danger btn-xs btnshow" title="Block"><i data-feather="x-circle" class="feather feather-x feather-sm"></i></a>
                              @else
                                <a href="/admin/utility/faq/changestatus/{{ $row->faq_id }}" class="btn btn-primary btn-xs btnbtn btnshow" title="Active"><i data-feather="user-check" class="feather feather-x feather-sm"></i></a>
                              @endif
                            <a href="/admin/utility/faq/update/{{ $row->faq_id }}"><button type="button" class="btn waves-effect waves-light btn-info">
                       ...
                       <div class="modal-dialog">
                         <div class="modal-content">
                           ...
                           <div class="modal-footer">
                             <form action="/admin/utility/faq/delete" method="post">
                               @csrf

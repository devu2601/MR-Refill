...
<section class="content">
        <div class="card card-primary card-outline">
			...
			@endif
				<div class="card-body">
				<form id="form" action="/admin/utility/faq/savedata" method="post" enctype="multipart/form-data" id="addEditcategory" novalidate="novalidate">
				@csrf
                                <input type="hidden" name="oldimage" id="oldimage" value="{{ $data->faq_img_url }}">
                                <input type="hidden" name="id" id="id" value="{{ $data->faq_id }}">
                                <div class="form-group">
                                <label for="txtquestion"><b>Question</b></label>
                                <input type="text" class="form-control" id="txtquestion" placeholder="Enter Question" name="txtquestion" value="{{ $data->faq_question }}">
                            </div> 
                            <br>     
                            <div class="form-group">
                                <label for="txtanswer"><b>Description</b></label>
                                <textarea class="form-control" name="txtanswer" id="txtanswer" rows="3">{{ $data->faq_answer }}</textarea>
                            </div>
							              <br>
                            <!-- <div class="form-group">
                              ...
                              <img src="{{ URL::to('/') }}/uploads/faq/{{ $data->faq_img_url }}" alt="">
                            </div>
                            <br> -->
                        ...
                        <div class="toggle-group">
                          ...
                          <label class="">
                              <input type="checkbox" @if($data->faq_active == "Active") checked @endif name="active" value="Active" id="option1" autocomplete="off"> Display
                          </label>
                            </div>
                        </div>
								      <br>

...
@section("admin-utilities-state")
<section class="content">
            <div class="card card-primary card-outline">
			<div class="card-header">
      		<h5 class="m-0"><b>Add State </b></h5>
    		</div>
		<div class="card-body">
			...
			<form id="form_category" action="/admin/utility/state/insert" method="post" enctype="multipart/form-data" id="addEditcategory" novalidate="novalidate">
				@csrf
				<div class="card-body">
							<div class="form-group">
								<label for="txtstatename">State name</label>
								<input type="text" class="form-control" id="txtstatename" placeholder="Enter the state name" name="txtstatename" value="">
							</div>
							<br>

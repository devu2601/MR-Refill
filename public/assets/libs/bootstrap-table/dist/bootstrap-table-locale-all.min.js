...
!(function (a) {
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["ar-SA"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " Ø³Ø¬Ù„ Ù„ÙƒÙ„ ØµÙØ­Ø©";
      },
      formatShowingRows: function (a, b, c) {
        return "Ø§Ù„Ø¸Ø§Ù‡Ø± " + a + " Ø¥Ù„Ù‰ " + b + " Ù…Ù† " + c + " Ø³Ø¬Ù„";
      },
      formatSearch: function () {
        return "Ø¨Ø­Ø«";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["ca-ES"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " resultats per pÃ gina";
      },
      formatShowingRows: function (a, b, c) {
        return (
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["cs-CZ"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " poloÅ¾ek na strÃ¡nku";
      },
      formatShowingRows: function (a, b, c) {
        return "Zobrazena " + a + ". - " + b + ". poloÅ¾ka z celkovÃ½ch " + c;
      },
      formatSearch: function () {
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["da-DK"] = {
      ...
      formatShowingRows: function (a, b, c) {
        return "Viser " + a + " til " + b + " af " + c + " rÃ¦kker";
      },
      formatSearch: function () {
        return "SÃ¸g";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["el-GR"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " Î±Ï€Î¿Ï„ÎµÎ»Î­ÏƒÎ¼Î±Ï„Î± Î±Î½Î¬ ÏƒÎµÎ»Î¯Î´Î±";
      },
      formatShowingRows: function (a, b, c) {
        return (
          "Î•Î¼Ï†Î±Î½Î¯Î¶Î¿Î½Ï„Î±Î¹ Î±Ï€ÏŒ Ï„Î·Î½ " +
          a +
          " Ï‰Ï‚ Ï„Î·Î½ " +
          b +
          " Î±Ï€ÏŒ ÏƒÏÎ½Î¿Î»Î¿ " +
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["es-AR"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " registros por pÃ¡gina";
      },
      formatShowingRows: function (a, b, c) {
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["es-ES"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " resultados por pÃ¡gina";
      },
      formatShowingRows: function (a, b, c) {
        return (
          "Mostrando desde " +
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["et-EE"] = {
      ...
      formatShowingRows: function (a, b, c) {
        return (
          "NÃ¤itan tulemusi " + a + " kuni " + b + " - kokku " + c + " tulemust"
        );
      },
      formatSearch: function () {
        return "Otsi";
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["fa-IR"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " Ø±Ú©ÙˆØ±Ø¯ Ø¯Ø± ØµÙØ­Ù‡";
      },
      formatShowingRows: function (a, b, c) {
        return "Ù†Ù…Ø§ÛŒØ´ " + a + " ØªØ§ " + b + " Ø§Ø² " + c + " Ø±Ø¯ÛŒÙ";
      },
      formatSearch: function () {
        return "Ø¬Ø³ØªØ¬Ùˆ";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["fr-BE"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " entrÃ©es par page";
      },
      formatShowingRows: function (a, b, c) {
        return "Affiche de" + a + " Ã  " + b + " sur " + c + " lignes";
      },
      formatSearch: function () {
        return "Recherche";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["fr-FR"] = {
      ...
      formatDuplicateAlertTitle: function () {
        return "Doublon(s) dÃ©tectÃ©(s)!";
      },
      formatDuplicateAlertDescription: function () {
        return "Supprimez ou changez les colonnes dupliquÃ©es.";
      },
      formatSortOrders: function () {
        return { asc: "Croissant", desc: "DÃ©croissant" };
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["hu-HU"] = {
      ...
      formatShowingRows: function (a, b, c) {
        return "MegjelenÃ­tve " + a + " - " + b + " / " + c + " Ã¶sszesen";
      },
      formatSearch: function () {
        return "KeresÃ©s";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["ja-JP"] = {
      ...
      formatRecordsPerPage: function (a) {
        return "ãƒšãƒ¼ã‚¸å½“ãŸã‚Šæœ€å¤§" + a + "ä»¶";
      },
      formatShowingRows: function (a, b, c) {
        return (
          "å…¨" + c + "ä»¶ã‹ã‚‰ã€" + a + "ã‹ã‚‰" + b + "ä»¶ç›®ã¾ã§è¡¨ç¤ºã—ã¦ã„ã¾ã™"
        );
      },
      formatSearch: function () {
        return "æ¤œç´¢";
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["ka-GE"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " áƒ©áƒáƒœáƒáƒ¬áƒ”áƒ áƒ˜ áƒ—áƒ˜áƒ—áƒ áƒ’áƒ•áƒ”áƒ áƒ“áƒ–áƒ”";
      },
      formatShowingRows: function (a, b, c) {
        return (
          "áƒœáƒáƒ©áƒ•áƒ”áƒœáƒ”áƒ‘áƒ˜áƒ " + a + "-áƒ“áƒáƒœ " + b + "-áƒ›áƒ“áƒ” áƒ©áƒáƒœáƒáƒ¬áƒ”áƒ áƒ˜ áƒ¯áƒáƒ›áƒ£áƒ áƒ˜ " + c + "-áƒ“áƒáƒœ"
        );
      },
      formatSearch: function () {
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["ko-KR"] = {
      ...
      formatRecordsPerPage: function (a) {
        return "íŽ˜ì´ì§€ ë‹¹ " + a + "ê°œ ë°ì´í„° ì¶œë ¥";
      },
      formatShowingRows: function (a, b, c) {
        return "ì „ì²´ " + c + "ê°œ ì¤‘ " + a + "~" + b + "ë²ˆì§¸ ë°ì´í„° ì¶œë ¥,";
      },
      formatSearch: function () {
        return "ê²€ìƒ‰";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["pl-PL"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " rekordÃ³w na stronÄ™";
      },
      formatShowingRows: function (a, b, c) {
        return "WyÅ›wietlanie rekordÃ³w od " + a + " do " + b + " z " + c;
      },
      formatSearch: function () {
        return "Szukaj";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["pt-BR"] = {
      ...
      formatShowingRows: function (a, b, c) {
        return "Exibindo " + a + " atÃ© " + b + " de " + c + " linhas";
      },
      formatSearch: function () {
        return "Pesquisar";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["ru-RU"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " Ð·Ð°Ð¿Ð¸ÑÐµÐ¹ Ð½Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñƒ";
      },
      formatShowingRows: function (a, b, c) {
        return "Ð—Ð°Ð¿Ð¸ÑÐ¸ Ñ " + a + " Ð¿Ð¾ " + b + " Ð¸Ð· " + c;
      },
      formatSearch: function () {
        return "ÐŸÐ¾Ð¸ÑÐº";
      },
      ...
      formatMultipleSort: function () {
        return "ÐœÐ½Ð¾Ð¶ÐµÑÑ‚Ð²ÐµÐ½Ð½Ð°Ñ ÑÐ¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²ÐºÐ°";
      },
      formatAddLevel: function () {
        return "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ";
      },
      formatDeleteLevel: function () {
        return "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ";
      },
      formatColumn: function () {
        return "ÐšÐ¾Ð»Ð¾Ð½ÐºÐ°";
      },
      formatOrder: function () {
        return "ÐŸÐ¾Ñ€ÑÐ´Ð¾Ðº";
      },
      formatSortBy: function () {
        return "Ð¡Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð¿Ð¾";
      },
      formatThenBy: function () {
        return "Ð·Ð°Ñ‚ÐµÐ¼ Ð¿Ð¾";
      },
      formatSort: function () {
        return "Ð¡Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ";
      },
      formatCancel: function () {
        return "ÐžÑ‚Ð¼ÐµÐ½Ð°";
      },
      formatDuplicateAlertTitle: function () {
        return "Ð”ÑƒÐ±Ð»Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ ÐºÐ¾Ð»Ð¾Ð½Ð¾Ðº!";
      },
      formatDuplicateAlertDescription: function () {
        return "Ð£Ð´Ð°Ð»Ð¸Ñ‚Ðµ, Ð¿Ð¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, Ð´ÑƒÐ±Ð»Ð¸Ñ€ÑƒÑŽÑ‰ÑƒÑŽ ÐºÐ¾Ð»Ð¾Ð½ÐºÑƒ, Ð¸Ð»Ð¸ Ð·Ð°Ð¼ÐµÐ½Ð¸Ñ‚Ðµ ÐµÐµ Ð½Ð° Ð´Ñ€ÑƒÐ³ÑƒÑŽ.";
      },
    }),
      a.extend(
        a.fn.bootstrapTable.defaults,
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["sk-SK"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " zÃ¡znamov na stranu";
      },
      formatShowingRows: function (a, b, c) {
        return "ZobrazenÃ¡ " + a + ". - " + b + ". poloÅ¾ka z celkovÃ½ch " + c;
      },
      formatSearch: function () {
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["th-TH"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " à¸£à¸²à¸¢à¸à¸²à¸£à¸•à¹ˆà¸­à¸«à¸™à¹‰à¸²";
      },
      formatShowingRows: function (a, b, c) {
        return "à¸£à¸²à¸¢à¸à¸²à¸£à¸—à¸µà¹ˆ " + a + " à¸–à¸¶à¸‡ " + b + " à¸ˆà¸²à¸à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸” " + c + " à¸£à¸²à¸¢à¸à¸²à¸£";
      },
      formatSearch: function () {
        return "à¸„à¹‰à¸™à¸«à¸²";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["tr-TR"] = {
      ...
      formatRecordsPerPage: function (a) {
        return "Sayfa baÅŸÄ±na " + a + " kayÄ±t.";
      },
      formatShowingRows: function (a, b, c) {
        return c + " kayÄ±ttan " + a + "-" + b + " arasÄ± gÃ¶steriliyor.";
      },
      formatSearch: function () {
        return "Ara";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["uk-UA"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " Ð·Ð°Ð¿Ð¸ÑÑ–Ð² Ð½Ð° ÑÑ‚Ð¾Ñ€Ñ–Ð½ÐºÑƒ";
      },
      formatShowingRows: function (a, b, c) {
        return "ÐŸÐ¾ÐºÐ°Ð·Ð°Ð½Ð¾ Ð· " + a + " Ð¿Ð¾ " + b + ". Ð’ÑÑŒÐ¾Ð³Ð¾: " + c;
      },
      formatSearch: function () {
        return "ÐŸÐ¾ÑˆÑƒÐº";
      },
      ...
      formatClearFilters: function () {
        return "ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚Ð¸ Ñ„Ñ–Ð»ÑŒÑ‚Ñ€Ð¸";
      },
      formatMultipleSort: function () {
        return "Ð¡Ð¾Ñ€Ñ‚ÑƒÐ²Ð°Ð½Ð½Ñ Ð·Ð° ÐºÑ–Ð»ÑŒÐºÐ¾Ð¼Ð° ÑÑ‚Ð¾Ð²Ð¿Ñ†ÑÐ¼Ð¸";
      },
      formatAddLevel: function () {
        return "Ð”Ð¾Ð´Ð°Ñ‚Ð¸ Ñ€Ñ–Ð²ÐµÐ½ÑŒ";
      },
      formatDeleteLevel: function () {
        return "Ð’Ð¸Ð´Ð°Ð»Ð¸Ñ‚Ð¸ Ñ€Ñ–Ð²ÐµÐ½ÑŒ";
      },
      formatColumn: function () {
        return "Ð¡Ñ‚Ð¾Ð²Ð¿ÐµÑ†ÑŒ";
      },
      formatOrder: function () {
        return "ÐŸÐ¾Ñ€ÑÐ´Ð¾Ðº";
      },
      formatSortBy: function () {
        return "Ð¡Ð¾Ñ€Ñ‚ÑƒÐ²Ð°Ñ‚Ð¸ Ð·Ð°";
      },
      formatThenBy: function () {
        return "Ð¿Ð¾Ñ‚Ñ–Ð¼ Ð·Ð°";
      },
      formatSort: function () {
        return "Ð¡Ð¾Ñ€Ñ‚ÑƒÐ²Ð°Ñ‚Ð¸";
      },
      formatCancel: function () {
        return "Ð¡ÐºÐ°ÑÑƒÐ²Ð°Ñ‚Ð¸";
      },
      formatDuplicateAlertTitle: function () {
        return "Ð”ÑƒÐ±Ð»ÑŽÐ²Ð°Ð½Ð½Ñ ÑÑ‚Ð¾Ð²Ð¿Ñ†Ñ–Ð²!";
      },
      formatDuplicateAlertDescription: function () {
        return "Ð’Ð¸Ð´Ð°Ð»Ñ–Ñ‚ÑŒ, Ð±ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ°, Ð´ÑƒÐ±Ð»ÑŽÑŽÑ‡Ð¸Ð¹ ÑÑ‚Ð¾Ð²Ð¿ÐµÑ†ÑŒ, Ð°Ð±Ð¾ Ð·Ð°Ð¼Ñ–Ð½Ñ–Ñ‚ÑŒ Ð¹Ð¾Ð³Ð¾ Ð½Ð° Ñ–Ð½ÑˆÐ¸Ð¹.";
      },
    }),
      a.extend(
        a.fn.bootstrapTable.defaults,
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["ur-PK"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " Ø±ÛŒÚ©Ø§Ø±ÚˆØ² ÙÛŒ ØµÙÛ ";
      },
      formatShowingRows: function (a, b, c) {
        return "Ø¯ÛŒÚ©Ú¾ÛŒÚº " + a + " Ø³Û’ " + b + " Ú©Û’ " + c + "Ø±ÛŒÚ©Ø§Ø±ÚˆØ²";
      },
      formatSearch: function () {
        return "ØªÙ„Ø§Ø´";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["vi-VN"] = {
      ...
      formatRecordsPerPage: function (a) {
        return a + " báº£n ghi má»—i trang";
      },
      formatShowingRows: function (a, b, c) {
        return (
          "Hiá»ƒn thá»‹ tá»« trang " + a + " Ä‘áº¿n " + b + " cá»§a " + c + " báº£ng ghi"
        );
      },
      formatSearch: function () {
        return "TÃ¬m kiáº¿m";
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["zh-CN"] = {
      ...
      formatRecordsPerPage: function (a) {
        return "æ¯é¡µæ˜¾ç¤º " + a + " æ¡è®°å½•";
      },
      formatShowingRows: function (a, b, c) {
        return "æ˜¾ç¤ºç¬¬ " + a + " åˆ°ç¬¬ " + b + " æ¡è®°å½•ï¼Œæ€»å…± " + c + " æ¡è®°å½•";
      },
      formatSearch: function () {
        return "æœç´¢";
      },
  ...
  (function (a) {
    ...
    (a.fn.bootstrapTable.locales["zh-TW"] = {
      ...
      formatRecordsPerPage: function (a) {
        return "æ¯é é¡¯ç¤º " + a + " é …è¨˜éŒ„";
      },
      formatShowingRows: function (a, b, c) {
        return "é¡¯ç¤ºç¬¬ " + a + " åˆ°ç¬¬ " + b + " é …è¨˜éŒ„ï¼Œç¸½å…± " + c + " é …è¨˜éŒ„";
      },
      formatSearch: function () {
        return "æœå°‹";
      },

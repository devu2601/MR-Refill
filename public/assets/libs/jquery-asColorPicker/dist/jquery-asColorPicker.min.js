...
!(function (t, e) {
  ...
  z.registerComponent("alpha", p),
    ...
    z.setLocalization("cn", { cancelText: "å–æ¶ˆ", applyText: "åº”ç”¨" }),
    z.setLocalization("de", { cancelText: "Abbrechen", applyText: "WÃ¤hlen" }),
    z.setLocalization("dk", { cancelText: "annuller", applyText: "VÃ¦lg" }),
    ...
    z.setLocalization("ja", { cancelText: "ä¸­æ­¢", applyText: "é¸æŠž" }),
    z.setLocalization("ru", { cancelText: "Ð¾Ñ‚Ð¼ÐµÐ½Ð°", applyText: "Ð²Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ" }),
    z.setLocalization("sv", { cancelText: "Avbryt", applyText: "VÃ¤lj" }),
